...
class LoginViewController: UIViewController {
    ...
    @objc func enterButtonPressed() {
        ...
        if mainView.enterButton.backgroundColor != UIColor(red: 0.754, green: 0.754, blue: 0.754, alpha: 1) {
            ...
            guard let name = mainView.nameTF.text, let password = mainView.passwordTF.text else {
    ...
    func handleLoginFailure(_ error: Error) {
        ...
        mainView.nameTF.textColor = UIColor(red: 0.954, green: 0.27, blue: 0.27, alpha: 1)
        mainView.passwordTF.textColor = UIColor(red: 0.954, green: 0.27, blue: 0.27, alpha: 1)
        mainView.underNameLine.backgroundColor = UIColor(red: 0.954, green: 0.27, blue: 0.27, alpha: 1)
        mainView.underPasswordLine.backgroundColor = UIColor(red: 0.954, green: 0.27, blue: 0.27, alpha: 1)
