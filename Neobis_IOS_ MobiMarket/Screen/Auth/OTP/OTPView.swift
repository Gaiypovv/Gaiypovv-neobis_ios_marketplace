...
class OTPView: UIView, UITextFieldDelegate {
    ...
    func setupConstraints() {
        ...
        mainLabel.snp.makeConstraints{
            $0.top.equalToSuperview().inset(232 * UIScreen.main.bounds.height / 812)
            $0.bottom.equalToSuperview().inset(561 * UIScreen.main.bounds.height / 812)
        ...
        descriptionLabel.snp.makeConstraints{
            $0.top.equalToSuperview().inset(263 * UIScreen.main.bounds.height / 812)
            $0.bottom.equalToSuperview().inset(511 * UIScreen.main.bounds.height / 812)
            $0.leading.equalToSuperview().inset(20 * UIScreen.main.bounds.width / 375)
            $0.trailing.equalToSuperview().inset(20 * UIScreen.main.bounds.width / 375)
        }
        
        codeField.snp.makeConstraints{
            $0.top.equalToSuperview().inset(334 * UIScreen.main.bounds.height / 812)
            $0.bottom.equalToSuperview().inset(444 * UIScreen.main.bounds.height / 812)
            $0.leading.equalToSuperview().inset(62 * UIScreen.main.bounds.width / 375)
            $0.trailing.equalToSuperview().inset(62 * UIScreen.main.bounds.width / 375)
        }
        ...
        errorLabel.snp.makeConstraints{
            $0.top.equalToSuperview().inset(384 * UIScreen.main.bounds.height / 812)
            $0.leading.equalToSuperview().inset(34 * UIScreen.main.bounds.width / 375)
            $0.trailing.equalToSuperview().inset(34 * UIScreen.main.bounds.width / 375)
            $0.bottom.equalToSuperview().inset(406 * UIScreen.main.bounds.height / 812)
        }
    }
}
